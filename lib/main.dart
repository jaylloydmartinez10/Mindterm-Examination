        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                calcbutton('AC',Colors.black,Colors.blueGrey),
                calcbutton('+/-',Colors.black,Colors.blueGrey),
                calcbutton('%',Colors.black,Colors.blueGrey),
                calcbutton('/',Colors.lightBlue,Colors.white),
              ],
            ),
            SizedBox(height: 10,),
            Row(
              ...
              children: <Widget>[
                ...
                calcbutton('x',Colors.lightBlue,Colors.white),
              ],
            ),
            SizedBox(height: 10,),
            Row(
